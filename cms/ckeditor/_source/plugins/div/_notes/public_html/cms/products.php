...
include $includes_dir ."includes/products.php";
...
<div class="CONTAINER">
  ...
  <div class="MIDDLE">
    ...
    <input type="hidden" name="lang" value="<?=$_GET['lang']?>">   
  	<br><br><br>    
    <input type="submit" name="add" value="הוסף מוצר" class="ABTN">
    <div class="TABLE">
    	<table>
        	<?
			switch($_GET['lang']) {
           ...
           <tr class="TRH">
            ...
            <?
			$i=0;
			$sql   = "SELECT * FROM $table WHERE sub = 0 AND language = '{$_GET['lang']}' ORDER BY sort DESC";			
			$query = $database->query($sql);
			while ($row=mysql_fetch_assoc($query)) {
				$i++;
				$add = '';
				include $includes_dir ."includes/templates.php";
				include "include/prow.php";
